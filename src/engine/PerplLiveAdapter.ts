...
export class PerplLiveAdapter implements ExchangeAdapter {
  ...
  refreshAccountState(): Promise<void> {
    return this.readonlyAdapter.refreshAccountState();
  }
  getPositions(market?: string): NormalizedPosition[] {
    return this.readonlyAdapter.getPositions(market);
  }
  getOpenOrders(market?: string): NormalizedOrder[] {
    return this.readonlyAdapter.getOpenOrders(market);
  }
  ...
  getOrderFills(id: string, market: string): Promise<NormalizedFill[]> {
    return this.readonlyAdapter.getOrderFills(id, market);
  }
  ...
  getAccountVolume(params: {
    ...
    return this.readonlyAdapter.getAccountVolume(params);
  }
